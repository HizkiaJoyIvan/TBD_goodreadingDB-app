...
const EditData = ({id}) => {
  ...
  const handleDone = async (e) => {
    ...
    try {
      ...
      await axios.put(`http://localhost:3200/api/address/${id}`, input)
...
const DeleteData = ({id}) => {
  ...
  const handleDone = async () => {
    try {
      await axios.delete(`http://localhost:3200/api/address/${id}`)
...
const AddData = () => {
  ...
  const handleDone = async (e) => {
    ...
    try {
      ...
      await axios.post(`http://localhost:3200/api/address`, input)
